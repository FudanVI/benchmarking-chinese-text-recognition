...
# data
parser.add_argument('--synthetic_train_data_dir', type=str,
                    default=['/home/guanmengnan/datasets/IIIT5K_3000/'])
...
parser.add_argument('--tps_inputsize', nargs='+', type=int, default=[32, 600])
parser.add_argument('--tps_outputsize', nargs='+', type=int, default=[32, 600])
# model
...
parser.add_argument('--loss_weights', nargs='+', type=float, default=[1,1,1,1])
# training configs
