...
parser.add_argument('--exp_name', type=str, help='experimental name')
parser.add_argument('--epoch', type=int, default=99999, help='number of epochs to train')
parser.add_argument('--lr', type=float, default=1.0, help='learning rate for critic')
...
parser.add_argument('--imageH', type=int, default=32, help='the height of the input image to network')
parser.add_argument('--imageW', type=int, default=128, help='the width of the input image to network')
