...
class RadicalBranch(nn.Module):
    ...
    def forward(self, attention_map, conv_feature, radical_input, radical_length):
        ...
        # print(attention_map.unsqueeze(2).size())
        # print(conv_feature_tmp.unsqueeze(1).size())

        char_maps = torch.mul(attention_map.unsqueeze(2), conv_feature_tmp.unsqueeze(1))
        # print(char_maps.size())
